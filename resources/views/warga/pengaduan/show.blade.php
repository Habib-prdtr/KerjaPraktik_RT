...
<div class="max-w-2xl mx-auto px-4 sm:px-6 space-y-6 pb-8">
    ...
    @php
        $sc = match($pengaduan->status) {
            ...
            default    => [
                ...
                'emoji' => '<svg class="w-6 h-6 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/></svg>'
            ],
        };
    @endphp
    ...
    <div class="bg-gradient-to-br {{ $sc['from'] }} {{ $sc['to'] }} rounded-[2rem] overflow-hidden shadow-xl shadow-emerald-900/10 relative">
        ...
        <div class="relative z-10 px-8 py-10 text-center">
            <div class="text-5xl mb-4 animate-bounce">{{ $sc['emoji'] }}</div>
    ...
    <div class="card-premium overflow-hidden bg-white border border-slate-100 shadow-sm">
        ...
        <div class="p-6">
            ...
            @if($pengaduan->foto)
            <div class="mt-5">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2.5">📸 FOTO BUKTI / LAMPIRAN</p>
    ...
    <div class="bg-gradient-to-br from-emerald-50 to-teal-50/50 border border-emerald-100 rounded-3xl p-6">
        <div class="flex items-center gap-3 mb-4">
            <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-600 flex items-center justify-center shadow-md shadow-emerald-600/20 text-xl shrink-0">
                💬
            </div>
            <div>
