        ...
        <form method="POST" action="{{ route('admin.pengumuman.store') }}" class="px-6 py-6 space-y-5">
            ...
            <div>
                ...
                <textarea id="isi" name="isi" rows="8" placeholder="Tulis isi pengumuman di sini…"
                          class="w-full px-4 py-3 text-sm rounded-xl border @error('isi') border-red-400 bg-red-50 @else border-slate-200 @enderror focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none leading-relaxed">{{ old('isi') }}</textarea>
